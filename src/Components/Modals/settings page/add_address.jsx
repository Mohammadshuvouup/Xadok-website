...
const NewAddress = (props) => {
  ...
  const [addLat, setAddLat] = useState(localStorage.getItem("current_location_lat"));
  const [addLng, setAddLng] = useState(localStorage.getItem("current_location_lng"));
  const initialValues = {
    ...
    >
      <Modal.Header style={{ border: "none" }} closeButton>
        <Modal.Title style={{ border: "none" }}>
          {addressId > 0 ? t("add_address.Edit-addresses") : t("add_address.New-addresses")}
        </Modal.Title>
      </Modal.Header>
      <Modal.Body className="new-addresses" style={{ border: "none" }}>
        ...
        <form
          ...
          <label>
            ...
            <select className="type" name="add_type" onChange={handleChangeType}>
          ...
          <label>
            ...
            <input type="text" name="add_note" value={addNote} onChange={handleChangeNote} />
          ...
          <label>
            ...
            <input type="text" name="add_mark" value={addMark} onChange={handleChangeMark} />
